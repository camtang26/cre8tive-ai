...
- Fast-forwarded `/home/cameronai/projects/cre8tive-website-master` to the rebased branch, reran `npm run build`, and pushed `master` (commit `9940f75`, followed by docs commit `841b22f`). GitHub Actions runs `Deploy to GitHub Pages` [19457199155] and [19457264526] both succeeded (<75 s each); production deploy is in flight for Cameron to smoke-test on `cre8tive.ai`.
