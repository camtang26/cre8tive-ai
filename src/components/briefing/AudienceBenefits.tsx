...
const agencyBenefits = [
  ...
  },
  {
    ...
    description:
      "Seven guided briefing fields capture product, audience, and guardrails in minutes.",
  ...
  },
  {
    ...
    description:
      "Every storyboard includes multiple durations (15s, 30s, 60s) and platform specs (YouTube 16:9, TikTok 9:16, Instagram 1:1)—no manual reformatting.",
...
const brandBenefits = [
  {
    ...
    description: "Go from concept to production-ready storyboard in minutes, not weeks.",
  ...
  },
  {
    ...
    description: "Curated style directions lock typography, tone, and color before production.",
  ...
  },
  {
    ...
    description:
      "Production-ready storyboards with scene notes, director notes, and platform specs. Hand off directly to our Studio or export as PDF.",
...
export const AudienceBenefits = () => {
  ...
  const handleToggle = (newType: "agency" | "brand") => {
    ...
    tl.to(
      ...
      "+=0.05"
    ) // Small pause before entrance
  }

  return (
    <section ref={sectionRef} className="relative isolate px-6 sm:px-12 lg:px-20 xl:px-28 py-24">
      <div
        className="absolute inset-0 -z-10 rounded-[48px] border border-white/8 bg-gradient-to-br from-black/70 via-black/60 to-black/80"
        aria-hidden
      />
      <div className="timeline-section-container mx-auto flex max-w-[1100px] flex-col gap-12">
        <div className="text-center md:text-left">
          ...
          <h2 className="mt-4 text-4xl font-black tracking-tight text-white md:text-5xl lg:text-[52px]">
            For Agencies & Brands Who Need Speed Without Compromise
          </h2>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-white/70 md:text-xl">
            Agencies scale multi-client workflows. Brands launch campaigns faster. Storyboard in 10
            minutes, video from our Studio—one platform from concept to delivery.
          </p>
        ...
        <div className="relative flex justify-center">
          <div className="w-full max-w-3xl">
            {/* Agency Panel */}
            <div
              className={`agency-panel flex-col gap-6 ${userType === "agency" ? "flex" : "hidden"}`}
            >
            ...
            {/* Brand Panel */}
            <div
              className={`brand-panel flex-col gap-6 ${userType === "brand" ? "flex" : "hidden"}`}
            >
              <div className="flex items-center justify-between rounded-2xl border border-white/12 bg-white/5 px-6 py-4 text-sm uppercase tracking-[0.45em] text-white/60 backdrop-blur-sm">
