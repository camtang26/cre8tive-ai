const PAIN_POINTS = [
  {
    ...
    summary: "8-week timelines, $50K minimums, and stacked teams that bill for every revision.",
  },
  {
    id: "ai-tools",
    label: "Pure AI Tools",
    summary: "Fast but fragile—artifacts, generic lighting, and zero human direction.",
  },
  {
    id: "in-house",
    label: "Building In-House",
    summary: "Full crew salaries, gear investments, and perpetual upskilling just to keep pace.",
  },
] as const
    ...
    >
      <div className="container mx-auto flex flex-col gap-16 px-4 py-24 md:gap-20 md:px-6 lg:flex-row lg:items-start lg:gap-24 xl:px-0">
        <div className="max-w-2xl space-y-6 text-white lg:max-w-lg">
          <div className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-4 py-1 text-xs font-semibold uppercase tracking-[0.38em] text-white/60">
          ...
          <div className="space-y-4 text-lg leading-relaxed text-studios-body md:text-[1.3rem]">
            ...
            <p>Meanwhile, clients need broadcast-grade video across six platforms. Yesterday. At budgets that actually make sense.</p>
            <p>Few have mastered AI video production—it only emerged in 2023. Fewer still maintain broadcast standards. Cre8tive Studios is one of them.</p>
          </div>
        </div>
        ...
        <div className="flex w-full flex-col gap-10">
          ...
          <article className="relative overflow-hidden rounded-[30px] border border-white/18 bg-gradient-to-br from-white/[0.18] via-white/[0.08] to-white/[0.04] px-8 py-10 shadow-[0_65px_200px_-90px_rgba(9,14,26,0.95)] backdrop-blur-3xl">
