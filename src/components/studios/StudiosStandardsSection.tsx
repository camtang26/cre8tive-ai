...
export function StudiosStandardsSection() {
  ...
  return (
    <section
      ...
      className="relative isolate overflow-hidden bg-[radial-gradient(circle_at_18%_12%,rgba(49,196,255,0.18),transparent_58%),radial-gradient(circle_at_82%_16%,rgba(225,179,65,0.16),transparent_60%),linear-gradient(150deg,rgba(6,9,18,0.98) 0%,rgba(8,14,28,0.96) 48%,rgba(5,10,24,0.98) 100%)] py-24 md:py-32"
    >
      ...
      <div className="container relative mx-auto max-w-5xl px-4 md:px-6 xl:px-0">
        <div className="relative overflow-hidden rounded-[38px] border border-white/12 bg-white/[0.03] p-[2px] shadow-[0_120px_260px_-120px_rgba(8,15,32,0.92)]" data-motion="standards-shell">
