...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*create-skill" workflow="{project-root}/bmad/bmb/skill-factory/workflows/create-skill/workflow.yaml">Create production-ready Claude Skill with TDD methodology - Type 1 (procedural/discipline) or Type 2 (domain expertise with KB), automated research, ruthless distillation, multi-model testing, <500 lines, official Anthropic compliance (Skill Factory v2.0)</item>
